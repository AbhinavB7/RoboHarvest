...
class RobotControl(Node):
    def __init__(self):
        ...
        self.end_goal = False
        # self.goal_position = [-1000.0, 800.0, 200.5, 0.0, 0.0, 0.0]
        self.goal_position = [-100.0, 750.0, 300.5, 0.0, 0.0, 0.0]
        # self.goal_position_2 = [800.0, 250.0, 500.5, 0.0, 0.0, 0.0]
        self.goal_position_2 = [800.0, -350.0, 450.5, 0.0, 0.0, 0.0]
    ...
    def inv_kin(self):
        ...
        while (i < Time and not self.end_goal):
            ...
            # make the robot stop for 5 sec
            # time.sleep(5)
                
            if (i > 199.8):
                status=True
                temp = self.home_pos
                self.home_pos = self.goal_position
                self.goal_position = self.goal_position_2
                x_dot = ((self.goal_position[0]-self.home_pos[0])/Time)
                y_dot = ((self.goal_position[1]-self.home_pos[1])/Time)
                z_dot = ((self.goal_position[2]-self.home_pos[2])/Time)
                wx = (self.goal_position[3]-self.home_pos[3])/Time
