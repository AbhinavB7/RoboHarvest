...
def generate_launch_description():
    ...
    world = os.path.join(
        get_package_share_directory('roboharvest'),
        'worlds',
        # 'empty_world.world'
        # 'garden.world'
        # 'farm6.world'
    ...
    pkg_gazebo = get_package_share_directory('roboharvest')
    ...
    rviz_config_dir = PathJoinSubstitution(
        [FindPackageShare("roboharvest"), "rviz", "display_default.rviz"]
    )
